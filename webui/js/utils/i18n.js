...
export const LANG = {
  zh: {
    ...
    'nav.directory': '目录',
    'nav.auxiliary': '辅助',
    'monitor.tokenTab': 'Token用量',
    'monitor.logsTab': '日志',
    'monitor.perfTab': '性能',
    'monitor.dirTab': '目录',
    'monitor.sysInfo': '系统信息',
    'monitor.resourceUsage': '资源使用',
    'monitor.largeFiles': '大文件',
    'monitor.port': '端口',
    'monitor.uptime': '运行时间',
    'monitor.memoryUsage': '内存使用',
    'monitor.cpuUsage': 'CPU 使用',
    'monitor.dbSize': '数据库大小',
    'monitor.sessions': '会话数',
    'auxiliary.title': '辅助模型',
    'auxiliary.desc': '配置辅助模型（后端待开发）',
    'tabModels': '模型管理',
    'tabAuxiliary': '辅助',
    'auxiliaryTitle': '🔧 辅助模型',
    'auxiliaryDesc': '辅助模型配置功能开发中，敬请期待...',
    'nav.language': '语言',
    'models.title': '模型管理',
    'models.globalPool': '全局模型池',
    'models.addNew': '添加新模型',
    ...
    'files.pathWindowsPh': 'C:\\\\Users\\\\Gavin\\\\Desktop 或 \\\\E:\\SiPer',
    'files.empty': '空目录',
    ...
    'apiDocs.download': '下载 JSON',
    'apiDocs.loadFailed': 'Swagger UI 加载失败，请检查网络连接',
    'apiDocs.renderFailed': 'Swagger UI 渲染失败: ',
    'apiDocs.viewJson': '直接查看 OpenAPI JSON',
    'apiDocs.copied': '已复制 ✓',
    'apiDocs.servers': '服务器',
    'apiDocs.version': '版本',
    'apiDocs.devServer': '开发服务器',
    'apiDocs.parameters': '参数',
    'apiDocs.noParameters': '无参数',
    'apiDocs.responses': '响应',
    'apiDocs.code': '状态码',
    'apiDocs.description': '说明',
    'apiDocs.links': '链接',
    'apiDocs.noLinks': '无链接',
    'apiDocs.success': '成功',
    'apiDocs.internalError': '服务器内部错误',
    'apiDocs.tryItOut': '试用',
    'apiDocs.execute': '执行',
    'apiDocs.cancel': '取消',
    'tasks.title': '任务管理',
    'tasks.comingSoon': '任务管理功能开发中...',
    'plugins.title': '插件管理',
    'plugins.comingSoon': '插件管理功能开发中...',
    'skills.title': '技能管理',
    'skills.empty': '暂无技能',
    'skills.enabled': '已启用',
    'skills.disabled': '已禁用',
    ...
    'settings.systemTab': '系统参数',
    'settings.agentTab': 'Agent管理',
    'settings.reset': '重置',
    'settings.refresh': '刷新',
    'settings.saved': '系统参数已保存',
    'settings.saveFailed': '保存失败',
    'settings.resetDone': '已恢复默认值',
    'settings.runtime': '运行时',
    'settings.wsHeartbeat': 'WS 心跳超时 (秒)',
    'settings.sessionLimit': '会话列表加载数',
    'settings.logBuffer': '日志缓冲区大小',
    'settings.tokenMax': 'Token 记录上限',
    'settings.ctxWindow': '上下文窗口默认值',
    'settings.agentManagement': '智能体管理',
    'settings.addAgent': '新增智能体',
  },
  en: {
    'nav.chat': 'Chat',
    'nav.chat': 'Chat',
    ...
    'nav.support': 'Support',
    'nav.monitor': 'Monitor',
    'nav.monitorPage': 'Monitor',
    'nav.performance': 'Performance',
    'nav.directory': 'Directory',
    'nav.auxiliary': 'Auxiliary',
    'monitor.tokenTab': 'Token Usage',
    'monitor.logsTab': 'Logs',
    'monitor.perfTab': 'Performance',
    'monitor.dirTab': 'Directory',
    'monitor.sysInfo': 'System Info',
    'monitor.resourceUsage': 'Resource Usage',
    'monitor.largeFiles': 'Large Files',
    'monitor.port': 'Port',
    'monitor.uptime': 'Uptime',
    'monitor.memoryUsage': 'Memory Usage',
    'monitor.cpuUsage': 'CPU Usage',
    'monitor.dbSize': 'DB Size',
    'monitor.sessions': 'Sessions',
    'auxiliary.title': 'Auxiliary Models',
    'auxiliary.desc': 'Configure auxiliary models (backend TBD)',
    'tabModels': 'Models',
    'tabAuxiliary': 'Auxiliary',
    'auxiliaryTitle': '🔧 Auxiliary Models',
    'auxiliaryDesc': 'Auxiliary model configuration is under development...',
    ...
    'files.pathWindowsPh': 'C:\\\\Users\\\\Gavin\\\\Desktop  or  \\\\E:\\SiPer',
    ...
    'apiDocs.download': 'Download JSON',
    'apiDocs.loadFailed': 'Failed to load Swagger UI, please check network connection',
    'apiDocs.renderFailed': 'Swagger UI render failed: ',
    'apiDocs.viewJson': 'View OpenAPI JSON directly',
    'apiDocs.copied': 'Copied ✓',
    'apiDocs.servers': 'Servers',
    'apiDocs.version': 'Version',
    'apiDocs.devServer': 'Development server',
    'apiDocs.parameters': 'Parameters',
    'apiDocs.noParameters': 'No parameters',
    'apiDocs.responses': 'Responses',
    'apiDocs.code': 'Code',
    'apiDocs.description': 'Description',
    'apiDocs.links': 'Links',
    'apiDocs.noLinks': 'No links',
    'apiDocs.success': 'Success',
    'apiDocs.internalError': 'Internal Server Error',
    'apiDocs.tryItOut': 'Try it out',
    'apiDocs.execute': 'Execute',
    'apiDocs.cancel': 'Cancel',
  },
  tw: {
    'nav.chat': '對話',
    'nav.sessions': '會話',
    ...
    'monitor.perfTab': '效能',
    'monitor.dirTab': '目錄',
    'monitor.sysInfo': '系統資訊',
    'monitor.resourceUsage': '資源使用',
    'monitor.largeFiles': '大文件',
    'monitor.port': '埠',
    'monitor.uptime': '運行時間',
    'monitor.memoryUsage': '記憶體使用',
    'monitor.cpuUsage': 'CPU 使用',
    'monitor.dbSize': '資料庫大小',
    'monitor.sessions': '會話數',
    'auxiliary.title': '輔助模型',
    'auxiliary.desc': '配置輔助模型（後端待開發）',
    'tabModels': '模型管理',
    'tabAuxiliary': '輔助',
    'auxiliaryTitle': '🔧 輔助模型',
    'auxiliaryDesc': '輔助模型配置功能開發中，敬請期待...',
    'theme.title': '外觀設置',
    'theme.colors': '顏色設置',
    'theme.sizes': '尺寸設置',
    'theme.templates': '模板管理',
    ...
    'apiDocs.title': 'API 文件',
    'apiDocs.download': '下載 JSON',
    'apiDocs.loadFailed': 'Swagger UI 載入失敗，請檢查網路連接',
    'apiDocs.renderFailed': 'Swagger UI 渲染失敗: ',
    'apiDocs.viewJson': '直接查看 OpenAPI JSON',
    'apiDocs.copied': '已複製 ✓',
    'apiDocs.servers': '伺服器',
    'apiDocs.version': '版本',
    'apiDocs.devServer': '開發伺服器',
    'apiDocs.parameters': '參數',
    'apiDocs.noParameters': '無參數',
    'apiDocs.responses': '回應',
    'apiDocs.code': '狀態碼',
    'apiDocs.description': '說明',
    'apiDocs.links': '連結',
    'apiDocs.noLinks': '無連結',
    'apiDocs.success': '成功',
    'apiDocs.internalError': '伺服器內部錯誤',
    'apiDocs.tryItOut': '試用',
    'apiDocs.execute': '執行',
    'apiDocs.cancel': '取消',
  },
