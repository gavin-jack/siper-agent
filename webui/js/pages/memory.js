// pages/memory.js — 记忆管理
// 从 pages/page-memory.js 迁移
...
export async function populateMemoryAgentSelector() {
  try {
...
export async function onMemoryAgentChange(name) {
...
export async function refreshMemoryPage() {
...
export async function saveMemoryMd() {
...
export async function refreshMemoryConfig() {
  try {
