...
function clearLogs() {
  ...
  const search = document.getElementById('chatLogSearchInput');
  if (search) search.value = '';
  const level = document.getElementById('chatLogLogLevel');
  if (level) level.value = '';
  const source = document.getElementById('logSourceFilter');
